...
class HalfEllipsePainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    path1.cubicTo(160.925 + offsetX, 24.3965 + offsetY, 167.55 + offsetX,
        32 + offsetY, 175.909 + offsetX, 32 + offsetY);
    path1.lineTo(214.091 + offsetX, 32 + offsetY);
    path1.cubicTo(222.45 + offsetX, 32 + offsetY, 229.075 + offsetX,
        24.3965 + offsetY, 224.61 + offsetX, 17.33 + offsetY);
    path1.cubicTo(218.41 + offsetX, 7.5171 + offsetY, 207.466 + offsetX,
        1 + offsetY, 195 + offsetX, 1 + offsetY);
    path1.cubicTo(182.534 + offsetX, 1 + offsetY, 171.59 + offsetX,
        7.5171 + offsetY, 165.39 + offsetX, 17.33 + offsetY);
    path1.close();

    var path2 = Path();
    path2.moveTo(162.728 + offsetX, 20.0282 + offsetY);
    path2.cubicTo(159.558 + offsetX, 26.422 + offsetY, 153.819 + offsetX,
        32 + offsetY, 146.682 + offsetX, 32 + offsetY);
    ...
    path2.cubicTo(236.181 + offsetX, 32 + offsetY, 230.442 + offsetX,
        26.422 + offsetY, 227.272 + offsetX, 20.0282 + offsetY);
    path2.cubicTo(221.387 + offsetX, 8.15917 + offsetY, 209.146 + offsetX,
        0 + offsetY, 195 + offsetX, 0 + offsetY);
    path2.cubicTo(180.854 + offsetX, 0 + offsetY, 168.613 + offsetX,
        8.15917 + offsetY, 162.728 + offsetX, 20.0282 + offsetY);
    path2.close();
